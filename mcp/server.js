...
class ExtensionBridge {
  ...
  #handleMessage(message) {
    if (message?.type === "hello") {
      ...
      this.socket?.write(encodeJsonLine({ type: 'bridge_status', connected: true }));
...
const mcp = new McpServer({ name: "xswitch-next", version: "2.0.0" });
...
registerV2Tools(mcp, bridge, tool);
