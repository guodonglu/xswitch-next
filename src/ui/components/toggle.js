...
export function toggle(label, checked, change) {
  ...
  return el('label', { class: 'relative inline-flex shrink-0 cursor-pointer items-center' }, input,
    el('span', { class: 'h-5 w-9 rounded-full bg-border-strong transition-colors duration-150 peer-checked:bg-primary peer-focus-visible:outline-2 peer-focus-visible:outline-offset-2 peer-focus-visible:outline-primary' }),
